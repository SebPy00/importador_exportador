                    ...
                    <tbody>
                        ...
                        for ($indiceFila = 2; $indiceFila <= $numeroMayorDeFila; $indiceFila++) {
                            ...
                            $sentencia->execute([
                                ...
                                $posible_doble_identidad, $doble_identidad_confir, $madre, $padre, $conyugue, $conyugue2, $hermanos_ci, $posibles_hermanos, $posible_hermanas_casadas, $informes_comerciales, $antec_policial, $ordenes_captura, $antec_judicial,$fecha_subido,$supervisor
                            ]);
